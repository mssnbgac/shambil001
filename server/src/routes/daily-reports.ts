...
router.get('/', auth, authorize('admin', 'director'), async (req: import('../middleware/auth').AuthRequest, res: import('express').Response) => {
  try {
...
router.get('/my-reports', auth, async (req: import('../middleware/auth').AuthRequest, res: import('express').Response) => {
  try {
    const { reportType, academicYear, term, status } = req.query;
    const filter: Record<string, any> = { submittedBy: req.user.id };
...
], async (req: import('../middleware/auth').AuthRequest, res: import('express').Response) => {
  try {
...
// Update report
router.put('/:id', auth, async (req: import('../middleware/auth').AuthRequest, res: import('express').Response) => {
  try {
